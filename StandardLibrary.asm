...
/*----------- Basic Functions on Sets--------------*/
   ...
   static count : Prod(Powerset(D),D) -> Natural
   static asSequence : Powerset(D) -> Seq(D)
   static asBag : Powerset(D) -> Bag(D)
   
   //Return one element of the given set, behavior undefined if set not empty
...
/*----------- Basic Functions on Products--------------*/
   ...
   static second : Prod(D1,D2,D3) -> D3 
   static second : Prod(D1,D2,D3,D4) -> D4 
